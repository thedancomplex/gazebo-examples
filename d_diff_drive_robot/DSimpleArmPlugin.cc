...
#include "DSimpleArmPlugin.hh"

//using namespace gazebo;
//GZ_REGISTER_MODEL_PLUGIN(DSimpleArmPlugin)
/////////////////////////////////////////////////

namespace gazebo
{
  class DSimpleArmPlugin : public ModelPlugin
  {


public: DSimpleArmPlugin()
{
                           ...
                           sdf::ElementPtr _sdf)
{
  ...
  this->velSub = this->node->Subscribe(std::string("~/") +
      ...
      &DSimpleArmPlugin::OnJointCmdMsg, this);
  ...
  this->updateConnection = event::Events::ConnectWorldUpdateBegin(
          boost::bind(&DSimpleArmPlugin::OnUpdate, this));
...
/////////////////////////////////////////////////
public: void OnJointCmdMsg(ConstJointCmdPtr &_msg)
{
